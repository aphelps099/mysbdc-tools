...
export const config = {
  matcher: [
     ...
     * - /api/tfg/applications/* (one-pager links from admin emails — secured by UUID)
     ...
     */
    '/((?!login|api/auth|api/tfg/applications|tfg-apply|_next|fonts|brand/assets|favicon\\.ico|.*\\.png|.*\\.svg|.*\\.ico|.*\\.jpg|.*\\.webp).*)',
  ],
};
