...
const RESOURCES = [
  ...
  {
    name: 'Social Content Library',
    description: 'Ready-to-post LinkedIn content for SBDC advisors and staff. Download PNG images and copy captions.',
    meta: 'LinkedIn \u00b7 10 Posts \u00b7 2 Banners',
    badge: 'Social',
    badgePool: true,
