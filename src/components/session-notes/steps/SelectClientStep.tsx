...
export default function SelectClientStep({ data, onChange, onNext, onBack, clients }: Props) {
  ...
  return (
    <div className="s641-step">
      <h2 className="s641-question">Select the business</h2>
      <p className="s641-subtitle">
        Choose which client record this session note is for.
      </p>
