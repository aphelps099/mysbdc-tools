...
/** Fonts we know are available out of the box. */
export function builtinFonts(): FontOption[] {
  return [
    { family: 'proxima-nova',       label: 'Proxima Nova',       source: 'typekit' },
    { family: 'proxima-sera',       label: 'Proxima Sera',       source: 'typekit' },
    { family: 'GT America',         label: 'GT America',         source: 'local' },
