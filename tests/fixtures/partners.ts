...
/* ═══════════════════════════════════════════════════════
   Partnership CRM — test fixture: the original 14-record
   sample dataset from the design handoff, kept for logic
   tests (the app seed itself is a single record).
   All fictional: *.example.* addresses, 555-01xx phones.
   ═══════════════════════════════════════════════════════ */

export const FIXTURE_PARTNERS: Partner[] = [
